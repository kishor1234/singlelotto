...
<div id="app-container">
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-text">
                                    <div class="row">
                                        <div class="col-12">
                                            <form  method="post" action="/?r=link&v=selldistributor">
    ...
    <!--                                                    <th  style="text-align: center;background-color: #3C8DBC; color: #FFF;"  class="col-xs-2" >
                                                ...
                                                <tbody>
                                                    ...
                                                    $sumofg = 0;
                                                    $sumofh = 0;
                                                    $responseData = $main->jsonRespon(api_url . "/?r=selldistributorreports", array("dateform" => $dateform, "dateto" => $dateto, "m" => $_SESSION["m"],"id" => $_SESSION["userid"]));
