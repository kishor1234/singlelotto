                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" id="own" name="own" required>
                                                            <?php
                                                            $responseData = $main->jsonRespon(api_url . "/?r=CAddAgent", array("action" => "allAgent{$_SESSION["m"]}", "id" => $_SESSION["userid"]));
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#myMainForm").submit(function () {
            ...
            //console.log('<?= api_url ?>/?r=agenttransaction&own=' + $("#own").val() + '&dateform=' + $("#dateform").val() + '&dateto=' + $("#dateto").val() + '&action=searchTicket');
