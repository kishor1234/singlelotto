                                                        ...
                                                        <form action="#" method="post" id="myMainForm">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="userid" id="userid" title="User Id">
                                                                    <?php
                                                                    $user_json = $main->jsonRespon(api_url . "/?r=CAddUser", array("action"=>"loaduser","sectionid" => $_SESSION['userid']));
                                                            ...
                                                            <div class="form-group">
                                                                <input type="hidden" name="create_by" id="create_by" value="<?= $_SESSION["userid"] ?>">
