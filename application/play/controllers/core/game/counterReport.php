...
class counterReport extends CAaskController {
    ...
    public function initialize() {
        ...
        $this->isLoadView(array("header" => null, "main" => "counterReport", "footer" => null, "error" => "page_404"), false, array("sdate" => $sdate, "edate" => $edate, "line" => $line, "response" => $response));
