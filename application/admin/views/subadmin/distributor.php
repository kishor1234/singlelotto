                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="#" method="post" id="myMainForm">
                                                            ...
                                                            <div class="form-group">
                                                                <?php
                                                                if (isset($_REQUEST) && $_REQUEST["m"] == "main") {
                                                                ?>
                                                                    <label class="form-control-label">Commission Percentage % (Ex 10% than put 0.1%)<small>Commission Percentage not update after create agent account</small> <span class="text-danger">*</span></label>
                                                                    <input type="number" placeholder="Enter user Commission Percenatage Ex 10% than put 0.1" title="Commission Percenatage" value="10"  readonly required autocomplete="off" class="form-control">
                                                                    <input type="hidden" step="0.01" max="0.1" min="0.01" value="0.1" readonly name="comission" id="comission" />
                                                                    <span id="error_name" class=""></span>
                                                                <?php
                                                                } else {
                                                                ?>
                                                                    ...
                                                                    <input type="number" placeholder="Enter user Commission Percenatage Ex 9% than put 0.09" title="Commission Percenatage" value="9"  readonly required autocomplete="off" class="form-control">
                                                                    <input type="hidden" step="0.01" max="0.1" min="0.01" value="0.09" readonly name="comission" id="comission" />
                                                                    <span id="error_name" class=""></span>
                                                                <?php
                                                                }
                                                                ?>
