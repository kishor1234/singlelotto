...
<div id="app-container">
    <div class="content-wrapper">
        ...
        <?php
        $page = "Super Distributor Sell Report";
        if ($_REQUEST["m"] === "admin") {
            $page = "Distributor Sell Report";
        }
        $main->isLoadView(array("header" => "webheader", "main" => "banner", "footer" => "webfooter", "error" => "page_404"), false, array("title" => $page, "link" => $link));
        ?>
        <!-- /.content-header -->
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-text">
                                    <div class="row">
                                        <div class="col-12">
                                            <form method="post" action="/?r=link&v=selldistributor&m=<?php echo $_REQUEST["m"];?>">
                                        ...
                                        <div class="col-12">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sumofg = 0;
                                                    $sumofh = 0;
                                                    $responseData = $main->jsonRespon(api_url . "/?r=selldistributorreportsall", array("dateform" => $dateform, "dateto" => $dateto, "m" => $_REQUEST["m"], "id" => $_SESSION["id"]));
