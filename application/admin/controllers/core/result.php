...
class result extends CAaskController {
    ...
    public function initialize() {
        ...
        try {
            ...
            $_REQUEST["result"] = $this->jsonRespon(api_url . "/?r=getResult", $data);
...
//           }
            ...
            $this->isLoadView(array("header" => "webheader", "main" => "result", "footer" => "webfooter", "error" => "page_404"), false, $_REQUEST);
        } catch (Exception $ex) {
            echo $ex->getMessage();
