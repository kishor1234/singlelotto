...
class autofillexvel extends CAaskController {
...
// Set data for dropdowns
        ...
        foreach ($continents as $key => $filename) {
            ...
            $spreadsheet->addNamedRange(
                    new NamedRange(
                    $continent, $spreadsheet->getActiveSheet(), $column . '1:' . $column . $countryCount
                    )
            );
            $spreadsheet->getActiveSheet()
...
// Hide the dropdown data
        ...
        $spreadsheet->addNamedRange(
                new NamedRange(
                'Continents', $spreadsheet->getActiveSheet(), $continentColumn . '1:' . $continentColumn . count($continents)
                )
        );
