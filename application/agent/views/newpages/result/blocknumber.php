                                ...
                                <div class=" row form-group">
                                    ...
                                    for ($i = 0; $i < 15; $i++) {
                                        ...
                                        <div class="col-lg-1">
                                            ...
                                            <input class='form-control' style=" margin:1px; padding:1px; border-radius: 5px; text-align:center; border-color: #FFAAD2; color:red; font-size: 20px;" type="text" maxlength="2" onkeypress="return isNumber(event)" name="<?php echo $i; ?>" id="<?php echo $i; ?>" class="form-control">
                                        </div>
                                    ...
                                    <input type="hidden" name="action" value="blockno">
                                    <div class="col-lg-12">
                                        <label>&nbsp;</label>
...
<script>
    ...
    function report() {
        $.post("<?= api_url ?>?r=CAddUser", {action: "getBlockno",id:"<?=$_SESSION["id"]?>"}, function (data) {
            console.log(data);
            var json=JSON.parse(data);
            console.log(json);
            for(var i=0;i<15;i++)
