                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="#" method="post" id="myMainForm">
                                                            ...
                                                            <input type="hidden" name="blockper" required id="blockper"  step="1"  min="1" max="100"  placeholder="Enter User Blocking Percentage" title="Enter User Blockging Percentage" autocomplete="off" class="form-control" value="1">
