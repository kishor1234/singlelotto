...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link" style="text-align:center;">
        <!--<img src="assets/static/logo/logo_pool.png" alt="AgentLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">-->
        <span class="brand-text font-weight-light center" style="text-align:center;">Agent Panel</span>
    </a>
...
<!--                            <span class="right badge badge-danger">New</span>-->
                ...
                <li class="nav-item">
                    <a href="javascript:void(0)" onclick="clickOnLink('/?r=dashboard&v=agentalltransaction', '#app-container', false)" class="nav-link">
                        <i class="nav-icon fas fa-th"></i>
                        <p>
                            Transaction
<!--                            <span class="right badge badge-danger">New</span>-->
