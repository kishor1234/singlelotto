    ...
    <script>
        ...
        $("document").ready(function () {
            ...
            function setSession(obj)
            {
                ...
                $.post("/?r=C_SetSession", {"email": obj.mobile, "agent_id": obj._id, "userid": obj.user_id, "ap": obj.ap, "commission": obj.commission,"createBy": obj.createBy}, function (data) {
                    console.log(data);
                });
            }
